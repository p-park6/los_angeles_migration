...
map <- top_pooled %>% #piping from top_pooled
  ...
  geom_point(color=ifelse(top_pooled$city_state %in% c("Los Angeles-CA"), "#2d4c75", "black"), 
             size = 3, 
...
geom_label(aes(label = ifelse(city_state %in% 
                                c(
                                  "New York-NY"), top_pooled$o_cz_name, NA)),
           fill = "white",
           color = "black",
           alpha = 1, 
           size = 5, 
...
geom_label(aes(label = ifelse(top_pooled$city_state %in% 
                                c(
                                  "San Francisco-CA"),top_pooled$o_cz_name, NA)),
           fill = "white",
           color = "black",
           alpha = 1, 
           size = 5, 
...
top_ten_lolli <- top_pooled %>% #piping from top_pooled
